...
namespace Linnso.CRUDGen.BL.BC
{
	public class SPGenBC
	{
		...
		public void SQLGenerarHeaderSP(StreamWriter sp, Modo modo)
		{
			...
			sp.WriteLine("-- Create date: " + (DateTime.Now.Day < 10 ? "0" + DateTime.Now.Day.ToString() : DateTime.Now.Day.ToString()) + "/" + (DateTime.Now.Month < 10 ? "0" + DateTime.Now.Month.ToString() : DateTime.Now.Month.ToString()) + "/" + DateTime.Now.Year + "");
			...
			switch(modo)
			{
				...
				case Modo.Seleccionar:
					...
					break;
				case Modo.Change_Estate:
					sp.WriteLine("-- Description: Cambia el estado de un elemento de la tabla " + _objTablaBE.Nombre);
					break;
			}
